...
\begin{document}
	...
	These solutions are then in turn examined and evaluated with the system criteria and requirements in mind, in order to determine if a solution is preferred over others based upon what solution gives the best quality information for the software system in an easy way.
	An exception to this is the Booking Software examination, which makes a concrete choice on what solution to choose. 
	In order to determine which solution is preferable, a discussion of the solutions is performed, after which an overall chosen solution for the entire system is given.
	...
	Some background material is needed for the development of a solution and is examined and discussed. This includes a description of the Internet of Things and what issues that follow, a description of the Model-View-Controller pattern used for the website, Asynchronous JavaScript and XML used for dynamic updating of webpages, and Simple Object Access Protocol to provide standardised web services.
	...
	Then the ER-diagram of the database is presented for both usage and logging purposes. 
	The architecture is also explained for both the website and the station software. 
	...
	This is covered by describing how we implement the GUI, Website Structure, Database, Interfaces, Model View Controller, Google Maps API, Administration Tools, Bicycle Simulation, Station Software, and Synchronisation.
	...
	\chapter{Test}
	Testing is an important aspect of ensuring that a system works as intended.
	That is why it is important to verify that the model and interface layer works as intended, and this can be done using unit testing, which is why we perform unit tests on those layers.
