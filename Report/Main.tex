...
\begin{document}
	...
	\chapter{Behaviour}
	This chapter will outline the behaviour of the system in the possible situations listed in \secref{sec:behaviourProblems}.
	\input{Src/Behavoir/problems}
		
	\chapter{Prototypes}
	This chapter will present prototypes of the visual design for system.
	\input{Src/Design/prototype}
