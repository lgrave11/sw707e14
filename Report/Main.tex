...
\begin{document}
	...
	\chapter{Design}
	This chapter will present the design of the product, where a prototype is created hereafter the ER-diagram of the database and architecture is explained\fxwarning{Er der mere}.
