...
When using the station and bicycles table on the website we make sure to only use the rows that are not marked as deleted, while for the history data we use all rows.
