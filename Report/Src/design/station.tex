...
The station field in the figure of the overall architecture is not just a single instance, it has its own architecture as well, which can be seen in \figref{fig:stationarch}. In this figure, as in the previous, the arrows represent flow of information.
