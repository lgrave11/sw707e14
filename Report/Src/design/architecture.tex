...
Taking a look at the architecture for the website, we see a MVC pattern in use, see \secref{sec:mvc}.
...
Two ways to interact with the system exist, which is with or without a booking and are described in \secref{sec:conceptretrieveandshit}.
