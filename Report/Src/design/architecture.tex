...
\begin{figure}[h]
	\centering
	\includegraphics[trim=2cm 1cm 0cm 1.5cm, clip, scale=0.7]{design/architecture}
...
Additionally, the three interfaces each serve a different purpose.
...
In that regard, we imagine a distinction between reserved unlocked bicycles and free bicycles, such that you do not on accident steal someone else's booked bicycle, see \secref{sec:conceptretrieveandshit}.
...
%forklaring af figur
%husk teori og fancy ord, SOAP web service er et eksempel
