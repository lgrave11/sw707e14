...
The architecture for the website is the MVC pattern, see \secref{sec:mvc}. There are other alternatives, such as Model View ViewModel or single pages doing everything, but we picked the MVC pattern because the idea behind it is very clear and easy to learn.
...
The administrator has access to an administrator webpage, where he can modify stations, bicycles, docks, and users.
