...
The communication device can then read from the sensors and contact the webservice via. TCP/IP or UDP.\fxwarning{We are uncertain of this, and should be furhter examined}
