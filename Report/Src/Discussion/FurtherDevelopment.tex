...
Other clustering libraries for google maps exist and would have to be compared before a specific algorithm were to be chosen, a good place to start would be \citep{misc:markerclusterapis}.
