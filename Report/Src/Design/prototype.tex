...
The booking history page can be seen in \figref{fig:prototype-usage-history}.
This page will show your whole booking history, which may be beneficial if you want to know your booking history.
It is generally an assuring fact that can show the user that their bookings have been handled correctly by the system.
Furthermore, it is a part you usually have for webshops and such too, to see your purchases, and you can for this page consider a purchase a metaphor for a booking.
