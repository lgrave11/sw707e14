...
The framework provides a controller base class, see \figref{fig:websitestructure}, that the new controllers inherit from, mainly providing a database instance.
