...
To use the API construction of the map is done first, which can be seen in \lstref{lst:mapoptions}.
...
The creation of stations can be seen in \lstref{lst:creationofstations}, which starts by creating an info window.
