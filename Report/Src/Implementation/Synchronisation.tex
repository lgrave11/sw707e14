...
This communication data flow have been illustrated in \figref{fig:overallarch}, additonally problem 1.4 in \chapref{chap:implementationproblems} have introduced the synchronisation problem.
...
\begin{description}[style=nextline]
	...
	However, it is not important to keep track on what bicycles are locked and unlocked at the station, as this information is of no use for the central system.
	...
	\begin{itemize}
		...
		\item Give user an error message, telling him to try and book/unbook again later. 
	\end{itemize}
