\section{Views}
This section will describe the view layer and what it does, first by illustrating by example and then providing an overview of the rest of the views and their function. For more detail about Model-View-Controller architecture, see \secref{sec:mvc}.
