...
Based on the website prototypes in \secref{sec:prototype}, a graphical user interface is implemented.
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{UI/overview}
...
In \figref{fig:UI-overview} the navigation bar contains five elements, of which the administrator element is only shown to administrators and directs the user to the administrator section of the site when clicked.
...
The navigation bar can be used to navigate to the various administrator tools, elaborated more in \secref{sec:impAdminTools}.
The only navigation bar element that does not direct to another administrator page, is the home element, which sends the user to the overview page, see \figref{fig:UI-overview}.
...
For an overview of the website a sitemap is created, see \figref{fig:sitemap}.
