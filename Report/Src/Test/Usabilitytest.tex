...
The tests subjects are part of the target audience, see \secref{sec:ta}, however, with more time it would be beneficial to have tests subjects with below average technological abilities to cover the whole target audience and address what issues might occur with such persons.
