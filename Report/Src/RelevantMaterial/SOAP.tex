...
We chose to use SOAP because while other methods are less verbose, faster, and simpler, SOAP provides a standard protocol that while complex and verbose is a very big benefit.\citep{misc:understandingsoapandrest}