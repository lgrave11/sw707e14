...
With the user controller taking care of everything connected to user login, editing of profile, logout etc.\fxwarning{Could put profile in a separate controller?}
...
This is relateds to the high modularity you gain with the MVC pattern, inducing high cohesion and low coupling.\fxwarning{Brat slutning.}