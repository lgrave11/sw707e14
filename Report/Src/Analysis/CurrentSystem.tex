...
This system is built on trust, because if people did not return the bicycles to a station when finished using them, the bicycles would gradually disappear.
...
Furthermore, it shows that over three season the percentage of bicycles lost has been at maximum 11 percent \citep{misc:aalborgcykling}.
