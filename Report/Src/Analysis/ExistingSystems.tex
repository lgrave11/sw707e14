...
The Cibi city bicycle system relies on SMS, where a booking of a bicycle is performed by sending an SMS to a special number with the ID of the bicycle slot in the docking station \citep{misc:cibi}. 
