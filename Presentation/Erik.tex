...
\begin{itemize}
	\item What are we dealing with?
	\item What problems are there to address? and why?
	\item How does the solution fit with the Internet of Things? (lasse ret lige til her)
	\item How did we manage to solve the problems?
	\item A demonstration of the outcome.
	\item What can be concluded from our work?
\end{itemize}
\end{frame}
...
\frametitle{Criteria}
	...
	\begin{itemize}
		\item As little change as possible, rather an extension the current system.
...
\textit{Not accessible to everyone.}
