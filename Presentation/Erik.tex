...
\begin{itemize}
	...
	\item How does the solution fit within the context of the Internet of Things? - Lasse
	\item How did we manage to solve the problems? - Søren
...
\textit{Easily understood by the user.}\\
\textit{Requires nothing from the user.}
