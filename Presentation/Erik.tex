...
\begin{itemize}
	...
	\item What problems are there to address? And what solution did we choose? - Erik
	...
	\item How did we structure the solution? - Søren
...
\frametitle{The Current System}
	...
	\begin{itemize}
		...
		\item Today: +102 bicycles and +2 stations.
		\item Open system, free to use.
		\item Each bicycle is used minimum 1.4 times during a day.
		\item AFA JCDecaux.
	\end{itemize}
\end{frame}
...
\frametitle{How Can We Solve These Problems?}
	...
	\begin{itemize}
		\item Status: Website.
		\item Booking: Special subscription(week, month, quarter) or booking online.
		\item Monitoring: Registering bicycles in docks or tracking their position with GPS.
	\end{itemize}
\end{frame}
