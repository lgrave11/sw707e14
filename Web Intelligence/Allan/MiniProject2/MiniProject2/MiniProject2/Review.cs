...
namespace MiniProject2
{
    class Review
    {
        ...
        public Review(string productid, string userid, string profilename, double helpfullness, double score, int time, string summary)
        {
            this.productID = productid;
            //this.profilename = profilename;
            //this.userID = userid;
            this.helpfulness = helpfullness;
            this.score = score;
            //this.time = time;
            //this.summary = summary;

            Tasks.Add(Task.Factory.StartNew(() => {tokenStream = Tokenizer.tokenize(summary).Distinct().ToList();}));
        ...
        {
            this.summary = summary;
            tokenStream = Tokenizer.tokenize(summary).Distinct().ToList();
        }
        ...
        public static List<Review> LoadAllReviews()
        {
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                {
                    counter = 0;
                    returnList.Add(new Review(productID, USerID, profilename, helpfulness, score, time, summary));
