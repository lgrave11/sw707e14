...
\begin{document}
	...
	A reason for this could be that the training set mainly consists of positive reviews, and as of such there is not as much training data for the negative reviews, making this classifier less accurate.
